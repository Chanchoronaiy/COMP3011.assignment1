...
- Run a real microphone-to-OpenAI request with the TITAN-provided runtime key
- Upload the executable JAR to TITAN and address any environment-specific failures
- Submit the readable GitHub repository URL through the required submission system

See `RUBRIC_CHECKLIST.md` for the requirement-to-code evidence map.
